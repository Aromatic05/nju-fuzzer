...
sudo apt-get install -y meson ninja-build    # QEMU mode
sudo apt-get install -y cpio libcapstone-dev # Nyx mode
sudo apt-get install -y wget curl            # Frida mode
sudo apt-get install -y python3-pip          # Unicorn mode
